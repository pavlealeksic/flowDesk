...
export declare const PluginManifestSchema: z.ZodObject<{
    ...
    tags: string[];
    category: "communication" | "productivity" | "development" | "crm" | "other" | "meetings" | "storage" | "support" | "marketing" | "finance" | "ai" | "utilities" | "themes";
    scopes: string[];
