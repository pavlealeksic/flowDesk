...
export declare const FlowDeskErrorSchema: z.ZodObject<{
    ...
    code: string;
    category: "unknown" | "validation" | "timeout" | "conflict" | "authentication" | "authorization" | "network" | "quota" | "rate_limit" | "billing" | "license" | "plugin" | "not_found" | "external" | "internal" | "sync" | "security" | "maintenance";
    message: string;
