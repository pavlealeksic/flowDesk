...
// import { useLogger } from '../src/renderer/logging/RendererLoggingService';
...
export class EnhancedConsole {
  ...
  log = (...args: any[]): void => {
    ...
    if (process.env.NODE_ENV === 'development') {
      this.logger.debug('Console log', undefined, { originalArgs: [...args], method: 'console.log' });
    }
  ...
  error = (...args: any[]): void => {
    // Forward to original console for development
    if (process.env.NODE_ENV === 'development') {
      this.logger.error('Console error', undefined, { originalArgs: [...args], method: 'console.error' });
    }
  ...
  warn = (...args: any[]): void => {
    // Forward to original console for development
    if (process.env.NODE_ENV === 'development') {
      this.logger.warn('Console warning', undefined, { originalArgs: [...args], method: 'console.warn' });
    }
  ...
  info = (...args: any[]): void => {
    // Forward to original console for development
    if (process.env.NODE_ENV === 'development') {
      this.logger.info('Console info', undefined, { originalArgs: [...args], method: 'console.info' });
    }
  ...
  debug = (...args: any[]): void => {
    // Forward to original console for development
    if (process.env.NODE_ENV === 'development') {
      this.logger.debug('Console debug', undefined, { originalArgs: [...args], method: 'console.debug' });
    }
  ...
  trace = (...args: any[]): void => {
    // Forward to original console for development
    if (process.env.NODE_ENV === 'development') {
      this.logger.trace('Console trace', undefined, { originalArgs: [...args], method: 'console.trace' });
    }
